...
from tg_bot.conf import get_str_key
from tg_bot.pluginhelpers import get_text, progress
from tg_bot import kp as pbot
...
__help__ = """		  
 /song or /music  <songname artist(optional)>: uploads the song in it's best quality available
 /video or /vsong <songname artist(optional)>: uploads the video song in it's best quality available
 /dsong <songname artist(optional)>: uploads the song  in it's best quality available
 /glyric or /glyrics <songname> will get  songs lyrics 
"""
